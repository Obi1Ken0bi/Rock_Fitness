    ...
    //    console.log(visit1)
     ...
     //   console.log(month)
      ...
      //  console.log(month,day)
        res.render('visitEdit',{visit:visit1,coach:coach,client:client1,otherClients:clients,otherCoaches:coaches,year:year,month:month,day:day})
    }
    ...
    async contractEdit(req,res,next){
     ...
     //   console.log(dayEnd)
      ...
      //  console.log(dayEnd)
       ...
       // console.log(cont)
        res.render('contractEdit',{contract:cont,yearStart:yearStart,monthStart:monthStart,dayStart:dayStart,yearEnd:yearEnd,monthEnd:monthEnd,dayEnd:dayEnd,admin:adm,otherAdmins:otherAdmins,client:cl,otherClients:otherClients})
    }
